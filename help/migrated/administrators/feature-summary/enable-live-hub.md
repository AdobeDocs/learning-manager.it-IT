...
1. Seleziona **IA in Learning** nel riquadro di navigazione a sinistra.
   ...
   ![Intelligenza Artificiale Nel Navigatore Apprendimento](assets/ai-in-learning-nav.png)
   *Seleziona IA in Learning per abilitare Hub dal vivo.*

1. Seleziona **Hub live**. <br> Viene aperta la pagina **Hub live**.

   ![Pagina Impostazioni hub live](assets/live-hub-settings-page.png)
   *Le impostazioni Live Hub mostrano l&#39;opzione per abilitare Live Hub in ALM.*

1. Attiva **Abilita Live Hub per questo account**. <br> Viene visualizzata la finestra di dialogo **Imposta hub dinamico come predefinito**.

   ![Imposta finestra di dialogo predefinita Hub live](assets/set-live-hub-default-dialog.png)
...
1. Attiva **L&#39;intelligenza artificiale nell&#39;hub live** per rendere disponibili gli assistenti basati sull&#39;intelligenza artificiale nelle sessioni dal vivo.
   ...
   ![Abilitare L&#39;Intelligenza Artificiale Nell&#39;Hub Live](assets/enable-ai-in-live-hub.png)
