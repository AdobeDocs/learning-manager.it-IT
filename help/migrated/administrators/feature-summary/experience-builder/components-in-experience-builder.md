---
title: Componenti principali di Experience Builder in Adobe Learning Manager
description: Scopri di più sui tre componenti principali di Experience Builder, inclusi Menu, Pagine e Widget.
jcr-language: en-us
...
ht-degree: 4%
---
# Componenti principali di Experience Builder

Experience Builder si basa su tre componenti principali: pagine, widget e menu. Gli amministratori possono creare pagine personalizzate utilizzando layout flessibili, aggiungere contenuti dinamici e statici tramite una libreria di widget e creare menu di navigazione mirati a gruppi di destinatari specifici.
