...
2. Seleziona **[!UICONTROL Impostazioni]** nella barra di navigazione a sinistra.

   ![testo alternativo](../settings/assets/Picture1.png)

3. Seleziona **[!UICONTROL Informazioni di base]** nella categoria **[!UICONTROL Nozioni di base]**.

   ![testo alternativo](../settings/assets/Picture2.png)

4. Seleziona **[!UICONTROL Modifica]** per modificare le impostazioni di base.
...
![testo alternativo](../settings/assets/Picture3.png)
...
![testo alternativo](../settings/assets/Picture4.png)
...
![testo alternativo](../settings/assets/Picture5.png)
...
1. **Aggiungi un nuovo promemoria**: nella sezione **[!UICONTROL Promemoria di feedback L1]**, seleziona **[!UICONTROL Aggiungi nuovo promemoria]**.

   ![testo alternativo](../settings/assets/Picture6.png)
...
3. **[!UICONTROL Salvare il promemoria]**: seleziona l&#39;icona del segno di spunta blu per salvare la nuova configurazione del promemoria. Puoi ripetere questa procedura per aggiungere altri promemoria, se necessario.
   ...
   ![testo alternativo](../settings/assets/Picture7.png)

4. Seleziona **[!UICONTROL Salva]** nell&#39;angolo superiore destro della pagina per applicare le impostazioni del feedback L1.
...
![testo alternativo](../settings/assets/Picture8.png)
...
4. Seleziona **[!UICONTROL Salva]** nell&#39;angolo superiore destro della pagina per applicare le impostazioni del feedback L3.
...
1. Ogni volta che l’Autore ripubblica un corso con modifiche, riceverai una notifica.
2. Selezionare la notifica per visualizzare le modifiche apportate dall&#39;autore.
3. Confrontate il contenuto vecchio e nuovo.
4. Approva o rifiuta le modifiche:
a. Approva le modifiche per ripubblicare il corso con gli aggiornamenti.
b. Rifiuta le modifiche per mantenere attiva la versione precedente del corso.
5. Gli Autori vengono informati della tua decisione, che si tratti di approvazione o rifiuto.
...
Seleziona **[!UICONTROL Modifica]** per limitare gli elementi visibili per gli Allievi:

![testo alternativo](../settings/assets/Picture10.png)
...
>[!NOTE]
>
>Per impostazione predefinita, i filtri **[!UICONTROL Formato]** e **[!UICONTROL Durata]** sono disattivati e non vengono visualizzati immediatamente dagli Allievi. È necessario selezionarli in modo esplicito.
...
![testo alternativo](../settings/assets/Picture11.png)
...
* Gli amministratori possono definire regole per determinare per quali cataloghi o corsi gli utenti vengono registrati automaticamente, in base agli attributi utente come ruoli, gruppi o altri criteri. Per ulteriori informazioni, consulta [Piani di apprendimento in Adobe Learning Manager](/help/migrated/administrators/feature-summary/learning-plans.md) o [Iscrizione automatica di gruppi di utenti esterni ai corsi al momento della registrazione](https://elearning.adobe.com/2024/05/automatically-enroll-external-user-groups-in-courses-upon-registration/).
...
1. **[!UICONTROL Aggiungi collegamenti]**: seleziona **[!UICONTROL Aggiungi altro]** e immetti il nome e l&#39;URL o l&#39;ID e-mail nei campi specificati. Assicurati che l’URL abbia il prefisso http:// o https://.
2. **[!UICONTROL Replica in più lingue]**: seleziona **[!UICONTROL Replica]** per applicare le modifiche in tutte le lingue in modo che tutte le lingue ricevano lo stesso nome e URL.
3. Seleziona **[!UICONTROL Salva]** per applicare le modifiche.

![testo alternativo](../settings/assets/Picture13.png)
...
Per ulteriori informazioni, consulta [Supporto per i distintivi Badgr](/help/migrated/learners/feature-summary/badges.md#support-for-badgr-badges).
...
Se selezioni **[!UICONTROL Abilita funzioni estese dei percorsi di apprendimento]**, puoi includere i percorsi di apprendimento all’interno dell’elenco e combinarli con i corsi. L’opzione è irreversibile.
...
Quando i corsi sono a pagamento, gli Autori possono specificare il prezzo del corso, del percorso di apprendimento o della certificazione. Gli Allievi possono acquistare corsi di formazione direttamente da Adobe Learning Manager o [siti AEM personalizzati](/help/migrated/integrate-aem-learning-manager.md).

>[!NOTE]
>
>Alcuni tipi di corso di formazione, come certificazioni ricorrenti e corsi approvati dal manager, non possono essere acquistati.
...
1. Seleziona **[!UICONTROL Abilita]**.
   ...
   ![testo alternativo](../settings/assets/Picture14.png)
