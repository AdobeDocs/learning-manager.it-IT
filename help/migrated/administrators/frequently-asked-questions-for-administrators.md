...
Sì, puoi aggiungere utenti in blocco utilizzando la funzione di caricamento CSV. Fai clic  [qui](/help/migrated/administrators/add-users-in-bulk.md) per ulteriori informazioni.

+++

+++Se si digita male l’ID e-mail durante la creazione del login per gli Allievi, come posso correggerlo?

Per correggere l’accesso degli utenti, devi importare un file CSV in Learning Manager. Nella parte inferiore di questa pagina trovi in allegato un file CSV di esempio da utilizzare come riferimento. Poiché l’e-mail è considerata un identificatore univoco di una persona, non può essere modificata. Effettua le seguenti operazioni:
...
1. Aggiungi altri utenti nel tuo account al file CSV, incluso te stesso
1. Importa questo file nell’app di amministrazione Learning Manager->Utenti->Aggiungi->Importa CSV
1. Associa tutti i campi, come richiesto nella finestra di dialogo, alle colonne CSV corrispondenti.
1. Fai clic su Salva.
...
Nell’Adobe Learning Manager 1.0, puoi creare notifiche. Riferimento  [domande sulle notifiche](/help/migrated/administrators/feature-summary/user-notifications.md) per ulteriori informazioni.

+++

+++Come si aggiungono i certificati per i corsi?

Adobe Learning Manager non fornisce certificati per i corsi. Tuttavia, l’Amministratore può creare distintivi per ogni corso facendo clic sulla scheda Distintivi nel pannello a sinistra. Quando l’Amministratore iscrive gli Allievi a un corso, può anche associarvi un badge.

+++

+++Come si importano le firme per i certificati?

Nell’Adobe di Learning Manager non è disponibile alcuna funzione che consenta di importare firme per la certificazione o il distintivo.
...
1. Fai clic su Lista di attesa nel riquadro a sinistra della pagina dei dettagli del corso. Nella pagina viene visualizzato un elenco di Allievi in lista di attesa.
...
Sì, puoi registrare le presenze procedendo come segue:
...
1. Seleziona gli allievi e fai clic su Salva per registrare il completamento del corso.

Se esistono più moduli in un corso e l’Allievo ne ha completato solo uno, puoi selezionare un singolo modulo e fare clic su Salva per contrassegnare il completamento per l’Allievo. Se l’Allievo completa tutti i moduli di un corso, puoi fare clic sull’opzione Seleziona tutto e quindi su Salva.
...
1. Aggiungi il nome del manager, il numero di posti assegnati e fai clic sul segno di spunta per salvare le modifiche.
...
Per iscrivere gli Allievi ai corsi, procedi come segue:
...
Per assegnare le competenze agli Allievi, procedi come segue:
...
Per creare un programma di apprendimento, segui i passaggi riportati di seguito:
...
Per modificare i report, fai clic sulla freccia a discesa nell’angolo superiore destro di ogni report. Una volta completate le modifiche e visualizzato il report modificato, fai clic su Salva.

+++

+++Come si modificano corsi, programmi di apprendimento e profilo aziendale?

Puoi modificare corsi o programmi di apprendimento anche dopo averli pubblicati. Per ulteriori informazioni, consulta  [Corsi](/help/migrated/administrators/feature-summary/courses.md) e  [programmi di apprendimento](/help/migrated/administrators/feature-summary/learning-programs.md) Contenuto della Guida.
...
Fai clic su Corsi nel riquadro a sinistra dopo aver effettuato l’accesso come Amministratore. Viene visualizzato un elenco di tutti i corsi disponibili.
...
A seconda della scelta, puoi visualizzare l’elenco filtrato di corsi e selezionare i corsi richiesti.

+++

+++È possibile modificare i temi dell’applicazione? Come?

Sì, puoi modificare i temi e il branding dell’applicazione Learning Manager in base alle esigenze dell’organizzazione. Viene fornito un set di cinque immagini rappresentative per visualizzare in anteprima le modifiche apportate al tema colore prima di applicarle all’applicazione. Sfogliate queste immagini facendo clic sui simboli &lt; e > rispettivamente sul lato sinistro e destro delle immagini per visualizzarne l&#39;anteprima.
...
1. Aggiungi nome distintivo.
1. Carica il distintivo facendo clic su Carica distintivo, quindi fai clic su Salva.
...
1. Dopo aver effettuato l’accesso come Amministratore, fai clic su Gamification. Viene visualizzata una pagina con un elenco di livelli bronzo, argento, oro e platino e i punti necessari per raggiungere ciascuno di essi. È disponibile un elenco di attività e punti corrispondenti.
1. Fate clic sull’icona Modifica accanto a ogni attività per impostare/modificare i punti.
...
Per creare un report, procedi come segue:
...
Puoi passare dal tuo account ad altri ruoli come Allievo, Manager e Autore senza uscire dal tuo account.

1. Fai clic sulla freccia a discesa accanto all’immagine del profilo nell’angolo superiore destro della pagina.\
...
Manager, Autori e Allievi possono visualizzare le notifiche in base alle attività del corso. L’Amministratore può abilitare/disabilitare le notifiche per tutti gli utenti effettuando le seguenti operazioni:
...
1. Dagli eventi elencati di seguito, fare clic sui pulsanti di attivazione No/Sì accanto a **ogni evento **e scegliere Sì per attivare la notifica. Fare clic su No per disattivare l&#39;invio di notifiche per un evento specifico.

+++

+++Come posso consentire l’iscrizione esterna ai corsi?

Adobe Learning Manager consente di iscrivere all’applicazione membri esterni al reparto o dipendenti esterni dell’organizzazione.
...
Crea un questionario di feedback che può essere utilizzato dagli Allievi dopo aver completato i corsi. Per impostazione predefinita, sono disponibili tre domande di esempio. Segui i passaggi riportati di seguito per creare il questionario.

1. Fai clic su Feedback nel riquadro a sinistra. Viene visualizzata una finestra del questionario di feedback.
1. Fai clic **[!UICONTROL Modifica]** per aggiungere/modificare il questionario.

Puoi aggiungere una serie di questionari e scegliere di non visualizzarli se non sono necessari. Per attivare/disattivare una determinata domanda, fai clic sulla casella di controllo corrispondente.
...
1. Fai clic su Aggiungi per aggiungere nuove competenze.
1. Aggiungi il nome, la descrizione e i crediti della competenza in base a ciascun livello.

   Per impostazione predefinita, per ogni competenza sarà disponibile un singolo livello con 0 crediti.
...
Una volta salvata la competenza, i relativi livelli non possono essere rimossi. L’Amministratore può anche assegnare agli Allievi una competenza e un livello specifici.
...
1. Digita il numero di pacchetti che desideri ordinare nel campo Pacchetti Allievo, quindi fai clic su Effettua ordine nell’angolo superiore destro della pagina.
...
1. Aggiungi il profilo, il sottodominio e il logo dell’azienda facendo clic su una di queste opzioni nella pagina.

+++

+++Come posso aggiungere corsi?

Per aggiungere corsi, è necessario cambiare il ruolo di Autore. Puoi visualizzare l’elenco dei corsi disponibili solo in base al relativo stato come **[!UICONTROL Completato]**, **[!UICONTROL Pubblicato]** e **[!UICONTROL Ritirato]**.
...
1. Fai clic su Utenti nel riquadro a sinistra dopo aver effettuato l’accesso come Amministratore. Puoi anche aggiungere gli utenti facendo clic su Guida introduttiva nel riquadro a sinistra della finestra e su Aggiungi utenti.
1. Per aggiungere nuovi utenti, fai clic su Aggiungi nell’angolo superiore destro della pagina.

Per impostazione predefinita, a tutti i nuovi utenti viene assegnato il ruolo di Allievo. È possibile assegnare ruoli Amministratore o Autore agli Allievi facendo clic su **[!UICONTROL Azioni]** nell&#39;angolo superiore destro della pagina e scegliendo **[!UICONTROL Assegna ruolo]** > **[!UICONTROL Crea autore]** oppure **[!UICONTROL Imposta come amministratore]**.
...
Puoi ottenere l’ID account dal browser in cui è aperto Learning Manager.
