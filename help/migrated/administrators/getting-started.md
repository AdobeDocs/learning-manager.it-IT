...
Queste fasi possono essere eseguite da tre ruoli diversi, da uno o più utenti in base all’assetto organizzativo. I tre ruoli sono i seguenti:
...
È possibile esaminare l’infografica fornita di seguito per ottenere una panoramica delle fasi e delle attività corrispondenti.
...
Nella fase 1, l’Amministratore IT dell’organizzazione può passare al ruolo di Amministratore dell’integrazione nell’applicazione Learning Manager e svolgere alcune attività di attivazione e integrazione come indicato di seguito:
...
* **Come singolo utente**: l’aggiunta di singoli utenti nell’applicazione Learning Manager consente di effettuare una prova con alcuni utenti prima di aggiungerli in blocco. Inoltre, questa opzione è utile quando si desidera aggiungere più utenti singoli in base alle esigenze, in seguito all’importazione degli utenti in blocco.
* **Registrazione autonoma**: questa opzione consente ai dipendenti di registrarsi a Learning Manager tramite il consenso degli Amministratori.
* **Importazione in blocco** (tramite caricamento CSV): utilizzando questa opzione è possibile importare gli utenti in blocco nell’applicazione Learning Manager. Come prerequisito, è necessario preparare l’elenco degli utenti in formato CSV prima di utilizzare questa funzionalità.
...
I programmi di apprendimento sono un set di corsi progettati specificatamente per soddisfare specifici obiettivi di apprendimento. Prima di creare programmi di apprendimento, assicurati di aver già creato alcuni corsi o di avere già a disposizione corsi esistenti nel tuo account.  Sebbene questa funzione sia facoltativa, il team Learning Manager consiglia di utilizzarla per favorire un apprendimento mirato per i dipendenti. Per iniziare a utilizzare i programmi di apprendimento, fai clic su Programmi di apprendimento nel riquadro di sinistra, seleziona un insieme di corsi dal catalogo e procedi con la pubblicazione. Per ulteriori informazioni, fai riferimento alla [Guida ai programmi di apprendimento](feature-summary/learning-programs.md).
...
Adobe Learning Manager consente di creare vari report per tracciare, monitorare e controllare le attività degli Allievi. Per generare i report, è possibile utilizzare i tre tipi di funzione di reporting indicati di seguito:

* **Report dashboard**: crea report di riepilogo per ottenere informazioni utili in merito alla fruizione dei contenuti di apprendimento da parte degli Allievi in base a varie categorie, come ad esempio gruppi di utenti, efficacia, tempo degli Allievi dedicato ai corsi e così via.
...
Per ulteriori informazioni in merito all’utilizzo delle funzioni dell’applicazione Learning Manager, fai riferimento alla [Guida a Learning Manager](../topics.md) relativa a ciascun ruolo.
