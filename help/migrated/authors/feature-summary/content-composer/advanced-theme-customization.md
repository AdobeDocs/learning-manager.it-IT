---
description: Scoprite come utilizzare le proprietà avanzate del tema in Composizione contenuto per personalizzare i singoli elementi di testo, inclusi i nomi di lezioni, argomenti, intestazioni di blocchi, didascalie e paragrafi, con controlli granulari per font e stili.
jcr-language: en_us
title: Personalizzazione avanzata del tema
...
1. Seleziona **Temi**, passa il mouse sul tema applicato, seleziona **Modifica**, quindi seleziona **Avanzate**.
   ![Pulsante Avanzate nel pannello Modifica tema](../assets/41_edit_theme_advanced_button_updated.png)
...
2. Nel pannello Proprietà font, imposta **Associazione font** per il corso:
   ...
   - Seleziona il menu a discesa **Corpo** e scegli un font per il corpo del testo.
     ![Scheda Proprietà font delle proprietà avanzate del tema, con le opzioni di abbinamento dei font](../assets/42_advanced_theme_properties_font_pairing_updated.png)
...
6. Visualizza in anteprima le modifiche nell&#39;area di lavoro a destra. Utilizza le schede **Lezione corrente** e **Lezione di prova** per verificare come vengono visualizzate le modifiche nelle diverse lezioni.
   ![Anteprima della lezione di prova nelle proprietà avanzate del tema](../assets/43_advanced_theme_test_lesson_preview_updated.png)
