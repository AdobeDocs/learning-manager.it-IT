---
description: Classifica gli utenti come interni ed esterni. Gli utenti interni sono gli utenti che appartengono a un'organizzazione specifica o a un gruppo.
jcr-language: en_us
...
Il gruppo di utenti non è altro che un insieme di utenti appartenenti a una categoria definita. In qualità di Amministratore, puoi utilizzare i gruppi di utenti per selezionare rapidamente gli Allievi in base ai relativi attributi. Inoltre, puoi assegnare rapidamente loghi o cataloghi al gruppo di utenti e generare report personalizzati sul relativo avanzamento.

Esistono due tipi di gruppi di utenti in Learning Manager: personalizzati e generati automaticamente. Quando aggiungi Allievi al tuo account, alcuni gruppi predefiniti vengono creati automaticamente in base ai ruoli e alle proprietà degli utenti nel tuo account. Questi gruppi vengono generati automaticamente. Ad esempio, un gruppo con tutti gli Allievi o tutti gli Autori.
...
Puoi anche creare gruppi personalizzati con un elenco selezionato di utenti in Learning Manager. I gruppi personalizzati consentono di specificare un nome, una descrizione e gli attributi per il gruppo di utenti. I gruppi personalizzati creati in Learning Manager sono di natura dinamica. Questo significa che se vengono aggiunti nuovi utenti con attributi simili, questi vengono aggiunti automaticamente ai suddetti gruppi di utenti.
