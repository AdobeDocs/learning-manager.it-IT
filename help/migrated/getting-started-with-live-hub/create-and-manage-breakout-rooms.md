...
1. Selezionare ![icona di interruzione](./assets/breakout-icon.svg) dalla barra dei controlli.

   ![Selezionare il pannello Sessioni Breakout](assets/select-breakout-sessions-panel.png)
...
1. Selezionare ![icona di interruzione](./assets/breakout-icon.svg) dalla barra dei controlli. <br> Viene visualizzato il pannello Breakouts.

   ![Apri pannello Breakouts](assets/open-breakouts-panel.png)
...
1. Seleziona **Salva**. <br> La sessione di breakout viene visualizzata nel pannello **Breakouts** con un tag **New**.
...
1. Seleziona **Avvia interruzioni**. <br> Una notifica mostra **A partire da 5 secondi** e gli Allievi vengono quindi spostati nelle sale riunioni assegnate con l’impostazione configurata applicata.

   ![Avvia sessione di analisi](assets/start-breakout-session.png)
...
1. Seleziona l’icona di modifica (matita) sulla sessione.
   ...
   ![Icona Modifica sessione di analisi](assets/edit-breakout-session-icon.png)
...
1. Seleziona altre opzioni (**...**) sulla sessione.
   ...
   ![Menu Duplica sessione di analisi stratificata](assets/duplicate-breakout-session-menu.png)
...
1. Seleziona **Elimina**. <br> Viene visualizzata una finestra di conferma a comparsa.

   ![Conferma eliminazione interruzione](assets/delete-breakout-confirmation.png)
...
1. Seleziona **Controlla stanza**. <br> Viene visualizzata una finestra a comparsa **Check Room** con il riepilogo della room.

   ![Riepilogo dell&#39;intelligenza artificiale della stanza di analisi](assets/breakout-room-ai-summary.png)
...
![Breakout Room Chat Panel](assets/breakout-room-chat-panel.png "Interfaccia della sessione Breakout che mostra il pannello Chat nella sala breakout.")
...
1. Selezionare **Termina interruzioni** nella sessione di interruzione attiva. <br> Tutti gli Allievi vengono spostati di nuovo nella stanza principale e la sessione di breakout termina per tutti i partecipanti.

   ![Termina sessione di analisi](assets/end-breakout-session.png)
