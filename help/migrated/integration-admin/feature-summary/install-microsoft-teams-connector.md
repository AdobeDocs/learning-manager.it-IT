...
jcr-language: en_us
title: Connettore Microsoft Teams
...
# Connettore Microsoft Teams in Adobe Learning Manager
...
1. Fai clic su **[!UICONTROL Nuova registrazione]**, inserisci le informazioni seguenti e registra l’applicazione:
...
1. Fai clic su **[!UICONTROL Nuovo segreto client]** e aggiungi le informazioni seguenti:
...
1. Accedi con l’E5 Microsoft che hai creato prima.
1. Cerca **Azure Active Directory**.
1. Fai clic su **[!UICONTROL Registrazioni app]**.
...
1. Ripeti i passaggi precedenti per tutti i nove API/le nove autorizzazioni che sono state aggiunte.
...
+++È necessario che un organizzatore sia un utente registrato sia su Learning Manager che su Microsoft Teams? 
...
+++È necessario che un relatore sia un utente registrato sia su Learning Manager che su Microsoft Teams? 
...
+++Microsoft Teams ha riunioni, webinar ed eventi in diretta. Quale di questi è supportato dal connettore di Teams? 

Al momento, il connettore Teams supporta solo le riunioni su Microsoft Teams. Per ulteriori informazioni, consulta questo [documento](https://docs.microsoft.com/en-us/microsoftteams/quick-start-meetings-live-events).
