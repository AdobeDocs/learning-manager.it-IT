...
1. Seleziona **Canali** dalla barra di navigazione superiore.
   ...
   Scheda ![Pagina tutti i canali](assets/channels-page-all-tab.png)
...
1. Selezionare il pulsante **Abbonati**.
   ...
   <br> Il canale è stato aggiunto alla scheda **Abbonato**.

1. Selezionare la scheda **Abbonato**.

   <br> Vengono visualizzati tutti i canali sottoscritti.

   ![Elenco canali sottoscritti](assets/subscribed-channels-list.png)
...
![Scheda Video Aggiunti Mi Piace](assets/liked-videos-tab.png)
...
1. Seleziona **Post**.
   ...
   <br> Il commento viene aggiunto al thread di discussione ed è visibile agli altri Allievi che visualizzano il video.

   ![Discussione video canale](assets/channel-video-discussion.png)
