...
Per coinvolgere gli Allievi e motivarli a raggiungere i loro obiettivi utilizzando tecniche di gioco, utilizza la funzionalità di gamification di Learning Manager. Gli Allievi possono competere con i colleghi per guadagnare punti per varie attività di apprendimento e raggiungere livelli bronzo, argento, oro e platino.

Gli Allievi possono inoltre visualizzare il livello di realizzazione in base ai punti guadagnati. I livelli includono Allievo rapido, Allievo proattivo e così via. **Sia gli Allievi interni che esterni possono accedere a questa funzione.**

## Classifica {#leaderboard}

Leaderboard è una funzionalità di gamification che funge da tabellone segnapunti per mostrare i punteggi dei principali concorrenti. Gli Allievi possono visualizzare i punti di gamification tramite la Classifica.

Nella home page dell’Allievo, fai clic su **[!UICONTROL Gamification]** dal riquadro sinistro. Per visualizzare la classifica, fai clic sul collegamento Classifica. Questa funzione consente agli Allievi di capire la loro posizione rispetto a un membro specifico del team. Viene inoltre mostrata la loro posizione rispetto ad altri membri del team.

Alcune funzioni della Classifica per Allievi:
...
* Fai clic **[!UICONTROL Aggiungi colleghi]** per includere il membro del team con cui eseguire il confronto. L’immagine del profilo del membro del team viene aggiunta alla scala della linea temporale nella parte superiore della pagina della classifica. Questa scala della linea temporale mostra i punti all’inizio e sposta la posizione verso destra quando ottieni più punti rispetto ai membri del team. Puoi confrontarlo solo con altri membri dello stesso gruppo.
* **Gruppi di utenti:** In qualsiasi momento puoi scegliere i profili dei membri del team con cui desideri confrontare il tuo punteggio, utilizzando il **[!UICONTROL Classificami con]** opzione. Nel campo Seleziona gruppi di utenti, digita e scegli il gruppo. Di seguito sono elencati l&#39;elenco di tutti i membri del team e i punti più recenti. Gli utenti interni ed esterni possono visualizzare l’elenco, ma solo gli utenti interni possono cercare altri Allievi interni.

* Inoltre, nella finestra di dialogo Persone con un livello simile al tuo vengono visualizzati i nomi dei membri del team con un livello superiore, inferiore o uguale al tuo.
* Quando un utente esterno si converte in un utente interno, la timeline viene aggiornata automaticamente.

## Punti per un apprendimento coerente
...
Tieni presente che i punti di gamification per questa regola vengono assegnati una volta ogni 24 ore. Ad esempio, se un Allievo svolge un’attività di apprendimento oggi alle 8:00 (PST) e riceve punti di gamification per oggi, domani sarà considerato per i punti di gamification solo se esegue un’attività di apprendimento in qualsiasi momento dopo le 8:00 PST.
...
Il sistema visualizza la pagina Gamification, che descrive tutte le attività e i punti degli Allievi è riportata di seguito:

>[!NOTE]
>
>I punti di gamification all’interno di un’attività particolare non sono cumulabili. Tuttavia, i punti vengono aggiunti all’account degli Allievi in modo cumulativo se gli Allievi ottengono questi punti in diverse attività.
>
...
>
>All’interno di un’attività, i punti non sono assegnati agli Allievi in maniera cumulativa. Ad esempio, si supponga che un Allievo completi un singolo corso e ottenga 20 punti. Quando gli Allievi completano due corsi, ottengono 100 punti ma i 20 punti esistenti non vengono considerati.
...
Questa attività è applicabile quando gli Allievi acquisiscono un certo numero di competenze. L’Amministratore può scegliere questa attività per incoraggiare gli Allievi a ottenere il maggior numero di competenze possibile.
...
Lo stato di livello degli Allievi viene visualizzato nell’angolo superiore destro della pagina in un cerchio, nella pagina I miei corsi. Gli Allievi possono raggiungere i seguenti diversi livelli in base al numero di punti guadagnati durante il periodo di apprendimento:
...
**1. Come visualizzare la classifica da Allievo?**

Nell’app per Allievi, nel riquadro a sinistra, fai clic su **[!UICONTROL Apprendimento sociale]**. Puoi visualizzare la classifica sociale nell’angolo in basso a destra della pagina.
