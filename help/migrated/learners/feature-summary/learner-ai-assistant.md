---
description: Ottieni risposte rapide e precise dai tuoi contenuti di apprendimento con l'Assistente all'intelligenza artificiale in Adobe Learning Manager.
jcr-language: en_us
...
L&#39;Assistente all&#39;intelligenza artificiale è un compagno di chat generativo in Adobe Learning Manager basato sull&#39;intelligenza artificiale che fornisce risposte rapide e precise utilizzando i contenuti di apprendimento affidabili. Include citazioni in modo da conoscere sempre la fonte delle informazioni.
...
Adobe elabora in modo sicuro i contenuti di apprendimento utilizzando servizi affidabili.
...
## Utilizzo dei contenuti da parte dell&#39;Assistente AI

L’Assistente AI trova risposte accurate dai contenuti di apprendimento. Ecco come funziona.

### Quali contenuti utilizza l&#39;Assistente AI

L’Assistente AI risponde alle domande utilizzando solo i contenuti di apprendimento abilitati dall’amministratore dell’account. Il contenuto dei cataloghi selezionati viene indicizzato.
...
L&#39;Assistente AI fornisce risposte in modo progressivo man mano che vengono generate, in modo da poter iniziare a leggere immediatamente senza attendere che venga caricata l&#39;intera risposta.
...
- Selezionate un numero di citazione agganciata per passare alla sezione a cui si fa riferimento.
- Aprire l&#39;elenco completo delle origini selezionando **Mostra origini** nella parte inferiore della risposta.
- Verificare le informazioni ed esplorare il contesto aggiuntivo dalla fonte autorevole.

> **IMPORTANTE**
> L&#39;Assistente AI fornisce le risposte in base al contenuto abilitato dall&#39;amministratore. Se non si dispone dell&#39;accesso a un elemento di riferimento, verrà visualizzato un messaggio &quot;non supportato&quot; quando si tenta di aprirlo.


## Suggerimenti incorporati

L&#39;Assistente all&#39;intelligenza artificiale include prompt incorporati per aiutarti a iniziare rapidamente con domande e scenari comuni. Questi suggerimenti ti guidano su come interagire con l&#39;assistente e dimostrano i tipi di domande che puoi porre.

![Suggerimenti incorporati forniti dall’Assistente Allievo](assets/built-in-prompt-new.png)

Le organizzazioni possono personalizzare i prompt incorporati per riflettere i propri obiettivi di apprendimento, ruoli, terminologia o casi d&#39;uso specifici. Gli amministratori possono collaborare con il proprio Customer Success Manager per configurare o aggiornare le richieste incorporate. Nella versione corrente, non è possibile personalizzare le richieste direttamente nell’interfaccia di Adobe Learning Manager.

## Configurare l&#39;Assistente all&#39;intelligenza artificiale (amministratori)
...
>[!IMPORTANT]
>
>Sono supportati solo **cataloghi interni**. Se è selezionato un catalogo **condiviso**, **acquisito**, **esterno** o un altro catalogo non interno, il suo contenuto non verrà visualizzato dall&#39;Assistente intelligenza artificiale, anche se è presente nell&#39;elenco **Cataloghi idonei**.

## Avvia l’Assistente all’intelligenza artificiale (allievi)
...
Puoi selezionare qualsiasi citazione per aprire la pagina del corso in Adobe Learning Manager e rivedere l’intero contenuto nel contesto. Le citazioni consentono di verificare le informazioni, esplorare ulteriori dettagli e continuare ad apprendere dalla fonte autorevole.

## Accedere all&#39;Assistente AI tramite la ricerca

Potete anche avviare l&#39;Assistente AI direttamente dalla barra di ricerca. Digita la domanda nel campo di ricerca, quindi seleziona **Richiedi Assistente AI** dalle opzioni visualizzate.

![Accedere all’Assistente Allievo dalla barra di ricerca](assets/learner-assistant-search-new.png)

## Fornisci feedback sulle risposte di AI Assistant

Il tuo feedback sulle risposte generate da AI Assistant (Beta) contribuisce a migliorarne l&#39;accuratezza, la pertinenza e le prestazioni complessive.
...
Avviare una nuova chat consente di iniziare una nuova conversazione, cancellando il contesto precedente in modo che l&#39;assistente possa concentrarsi sul nuovo argomento senza fare riferimento alle interazioni precedenti.

Per cancellare la conversazione corrente e ricominciare, seleziona **Nuova chat** nella schermata dell&#39;Assistente AI, quindi seleziona **Sì**.
...
**Problema:** un Allievo ha accesso all’Assistente all’intelligenza artificiale ma riceve risposte &quot;Non ho una risposta a questa domanda&quot;.

**Cause possibili:**

- I cataloghi dell’Allievo non sono inclusi nella configurazione dell’Assistente AI.
...
- Verifica l’accesso dell’Allievo al catalogo.
- Controllate quali cataloghi sono abilitati nelle impostazioni dell&#39;Assistente AI.
- Assicurati che in tali cataloghi siano presenti contenuti pertinenti.
- Attendere qualche ora dopo l&#39;aggiunta di nuovo contenuto per l&#39;indicizzazione.

### Risposte irrilevanti o di scarsa qualità

**Problema:** l&#39;Assistente all&#39;intelligenza artificiale fornisce risposte che non corrispondono alla domanda o che sono di bassa qualità.

**Cause possibili:**

- La domanda è troppo ampia o ambigua.
- I metadati del contenuto pertinente sono insufficienti (descrizioni, tag).
...
- Rivedere e migliorare le descrizioni dei corsi e i metadati.
- Assicurati che il contenuto abbia intestazioni e struttura chiare.
...
### Domande non incluse nell&#39;ambito

**Problema:** un Allievo pone domande non correlate al contenuto della formazione.

**Esempi:**

- Domande generali sulla conoscenza (&quot;Chi è il presidente?&quot;)
