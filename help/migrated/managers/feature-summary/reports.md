...
Un manager può visualizzare le informazioni sul proprio team diretto o indiretto sotto forma di riepilogo.

Il manager può quindi filtrare il report in base a intervalli di tempo come trimestre, mese corrente, ultimi tre mesi interi e ultimi 12 mesi interi.
...
**Asse Y principale** scegli il criterio primo/principale per il report dalle opzioni a discesa. Per alcuni dei criteri selezionati, puoi scegliere uno o più stati dalla casella a discesa Stati adiacente. Ad esempio, per un criterio principale per le statistiche di iscrizione al corso, gli stati possono essere completati, incompleti, registrati e così via. I dati dell’intervallo principale sono rappresentati sotto forma di grafici a barre nel report.

**Asse Y secondario** scegli l’intervallo/criterio asse Y secondario per il report dalle opzioni a discesa. Ad esempio, nell’opzione di iscrizione al programma di apprendimento, scegli uno o più stati dalla casella a discesa Stati adiacente. I dati dell’intervallo secondario sono rappresentati sotto forma di grafici a linea.
...
Un altro menu a discesa **Seleziona** viene visualizzato accanto all’asse X con un elenco di gruppi di utenti disponibili per l’account. In questo menu a discesa puoi selezionare uno o più gruppi di utenti.
...
Fai clic su questa scheda per visualizzare alcuni report indicativi basati su punti di dati di esempio. Esplora questi report per avere un’idea dei diversi tipi di report ricchi di funzionalità che puoi generare utilizzando i dati del tuo account.

**I miei report**

Fai clic sulla scheda della bacheca per visualizzare tutte le bacheche create. Dall’elenco a discesa della bacheca di visualizzazione puoi selezionare la bacheca predefinita o qualsiasi bacheca creata.
...
Fai clic sull’icona **Modifica** nell’angolo destro del nome del report dall’elenco dei report per modificare in qualsiasi momento la sottoscrizione.
...
Se più Manager ti inviano report, puoi visualizzare rapidamente i report per ogni Manager. Scegli il nome del Manager dall’elenco a discesa per visualizzare un report univoco per ogni Manager.
...
**Modifica** durante la modifica dei dati, per tornare ai valori iniziali, fai clic sull’opzione di ripristino. Fai clic su Salva dopo aver modificato i valori.
...
Inizia a digitare il nome del report nel campo Report per selezionare il nome del report dall’elenco a discesa. Scegli la frequenza delle e-mail, come quotidiana, settimanale, mensile, come desiderato, aggiungi l’oggetto dell’e-mail e fai clic su Aggiungi per iscriverti.

Fai clic su Modifica per modificare l’iscrizione. Fai clic su Rimuovi per eliminare l’iscrizione.
